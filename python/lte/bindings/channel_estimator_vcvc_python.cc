...
/* BINDTOOL_HEADER_FILE_HASH(a8afa9870588fec88b2a082668a47907)                     */
/***********************************************************************************/
...
void bind_channel_estimator_vcvc(py::module& m)
{
    ...
    py::class_<channel_estimator_vcvc, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def("set_pilot_map",&channel_estimator_vcvc::set_pilot_map,       
            py::arg("pilot_carriers"),
            py::arg("pilot_symbols"),
            D(channel_estimator_vcvc,set_pilot_map)
        )


        
        .def("get_pilot_carriers",&channel_estimator_vcvc::get_pilot_carriers,       
            D(channel_estimator_vcvc,get_pilot_carriers)
        )
